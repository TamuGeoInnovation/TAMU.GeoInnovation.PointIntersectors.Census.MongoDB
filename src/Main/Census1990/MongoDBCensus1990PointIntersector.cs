...
namespace TAMU.GeoInnovation.PointIntersectors.Census.MongoDB.Census1990
{
    [Serializable]
    public class MongoDBCensus1990PointIntersector : AbstractCensus1990PointIntersector
    {
        ...
        public MongoDBCensus1990PointIntersector()
            : base()
        { }

        public MongoDBCensus1990PointIntersector(double version, IQueryManager blockFilesQueryManager, IQueryManager stateFilesQueryManager, IQueryManager countryFilesQueryManager)
            : base(version, blockFilesQueryManager, stateFilesQueryManager, countryFilesQueryManager)
        { }

        public MongoDBCensus1990PointIntersector(Version version, IQueryManager blockFilesQueryManager, IQueryManager stateFilesQueryManager, IQueryManager countryFilesQueryManager)
            : base(version, blockFilesQueryManager, stateFilesQueryManager, countryFilesQueryManager)
        { }
